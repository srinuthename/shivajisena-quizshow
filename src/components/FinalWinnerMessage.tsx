  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center glass-background">
      ...
      >
        ...
        >
          <Trophy className="w-24 h-24 text-biblical-gold" />
          <motion.div
            animate={{ 
              scale: [1, 1.2, 1],
              opacity: [0.5, 1, 0.5]
            ...
            className="absolute inset-0 bg-biblical-gold/30 rounded-full blur-xl"
          />
        </motion.div>
        ...
        <motion.p
          ...
          className="text-2xl md:text-3xl text-biblical-text mb-6"
        >
