...
interface PowerplayOverlayProps {
  showStartFlash: boolean;
  showEndFlash: boolean;
}

export const PowerplayOverlay = ({ showStartFlash, showEndFlash }: PowerplayOverlayProps) => {
  const { t } = useTranslation();
  return (
    <>
      {/* Powerplay Start Fullscreen Flash Animation */}
      <AnimatePresence>
        {showStartFlash && (
          <motion.div
            initial={{ opacity: 0 }}
